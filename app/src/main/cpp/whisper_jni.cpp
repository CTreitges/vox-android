// JNI-Bruecke zwischen Kotlin (com.chris.whisperbar.whisper.WhisperLib) und whisper.cpp (v1.9.3).
//
// Die Symbolnamen MUESSEN exakt zu Paket + Objektname der Kotlin-Seite passen:
//   Java_com_chris_whisperbar_whisper_WhisperLib_<methode>
...
Java_com_chris_whisperbar_whisper_WhisperLib_initContext(
...
Java_com_chris_whisperbar_whisper_WhisperLib_freeContext(
...
Java_com_chris_whisperbar_whisper_WhisperLib_fullTranscribe(
        JNIEnv *env, jobject thiz, jlong context_ptr,
...
JNIEXPORT void JNICALL
Java_com_chris_whisperbar_whisper_WhisperLib_requestAbort(JNIEnv *env, jobject thiz) {
    (void) env; (void) thiz;
    g_abort.store(true);
}

JNIEXPORT jint JNICALL
Java_com_chris_whisperbar_whisper_WhisperLib_getTextSegmentCount(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    (void) env; (void) thiz;
...
Java_com_chris_whisperbar_whisper_WhisperLib_getTextSegment(
...
JNIEXPORT jstring JNICALL
Java_com_chris_whisperbar_whisper_WhisperLib_getDetectedLanguage(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    (void) thiz;
...
JNIEXPORT jstring JNICALL
Java_com_chris_whisperbar_whisper_WhisperLib_getSystemInfo(JNIEnv *env, jobject thiz) {
    (void) thiz;
...
JNIEXPORT void JNICALL
Java_com_chris_whisperbar_whisper_WhisperLib_printTimings(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    (void) env; (void) thiz;
