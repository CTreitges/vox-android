...
class ModelDownloadService : Service() {
    ...
    private fun begin(model: WhisperModel) {
        ...
        Thread({ run(model, store) }, "wb-model-download").start()
    }
    ...
    private fun notification(model: WhisperModel?, percent: Int): Notification {
        val builder = Notification.Builder(this, CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_stat_whisperbar)
    ...
    companion object {
        ...
        const val ACTION_START = "com.chris.whisperbar.action.MODEL_DOWNLOAD_START"
        const val ACTION_CANCEL = "com.chris.whisperbar.action.MODEL_DOWNLOAD_CANCEL"
        const val EXTRA_MODEL_ID = "modelId"
        const val MSG_TIMEOUT = "Zeitlimit für Hintergrund-Downloads erreicht — bitte erneut starten"

        private const val CHANNEL_ID = "whisperbar_models"
