 ...
 * der Frame-Takt. Ohne Aufnahme liegen die Balken flach in wb_surfaceContainerHighest,
 * waehrend der Aufnahme leuchten sie in wb_recording.
 */
class LevelBandView @JvmOverloads constructor(
    ...
    private val activeColor = context.getColor(R.color.wb_recording)
    private val idleColor = context.getColor(R.color.wb_surfaceContainerHighest)
