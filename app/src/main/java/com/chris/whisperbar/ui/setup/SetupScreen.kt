...
import com.chris.whisperbar.ui.components.StepStateChip
import com.chris.whisperbar.ui.components.WbIcon
import com.chris.whisperbar.ui.components.findActivity
            ...
            SmallTopBar(
                ...
                if (inSteps) {
                    IconButton(onClick = { showOverview = true }) {
                        WbIcon(R.drawable.ic_checklist, stringResource(R.string.setup_cd_overview))
                    }
                }
            }
        },
    ...
    Column(Modifier.fillMaxSize()) {
        Column(
            ...
            Box(
                ...
                WbIcon(ui.icon, null, Modifier.size(36.dp), MaterialTheme.colorScheme.onPrimaryContainer)
            }
