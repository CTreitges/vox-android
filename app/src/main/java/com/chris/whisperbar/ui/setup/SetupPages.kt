...
private fun WelcomePoint(icon: Int, text: String) {
    WbRow(headline = text, leading = { WbIcon(icon, null, Modifier.size(24.dp), MaterialTheme.colorScheme.primary) })
}
        ...
        Column(
            ...
            Box(
                Modifier
                    ...
                    .background(MaterialTheme.wb.successContainer, CircleShape),
                contentAlignment = Alignment.Center,
            ) {
                WbIcon(R.drawable.ic_check, null, Modifier.size(48.dp), MaterialTheme.wb.onSuccessContainer)
            }
