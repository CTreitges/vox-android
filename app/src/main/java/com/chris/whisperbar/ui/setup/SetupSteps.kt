...
private fun EngineOption(
    ...
    OutlinedCard(
        ...
        Row(
            ...
            WbIcon(icon, null, Modifier.size(28.dp), iconTint)
            Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                if (unavailable != null) {
                    StatusChip(unavailable, R.drawable.ic_warning, MaterialTheme.wb.warningContainer, MaterialTheme.wb.onWarningContainer)
                }
            }
        }
    }
