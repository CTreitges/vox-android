...
/**
 * Direkte JNI-Bindings zu libvox.so. Die Methodennamen MUESSEN exakt zu den
 * `Java_com_chris_vox_whisper_WhisperLib_*`-Symbolen in src/main/cpp/whisper_jni.cpp
...
internal object WhisperLib {
    ...
    private fun loadLibrary(): Boolean = try {
        ...
        Log.w("WhisperLib", "libvox.so nicht ladbar: ${e.message}")
        false
    }
