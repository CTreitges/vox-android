...
import com.chris.vox.api.TextRefiner
...
import com.chris.vox.whisper.OfflineStatus
import java.io.File
...
object TranscriptionEngine {
     ...
     * @throws ApiNotConfiguredException wenn keine Engine gewaehlt oder der Zugang unvollstaendig ist.
     * @throws OfflineNotAvailableException wenn offline gewaehlt ist, aber kein Modell da.
     * @throws com.chris.vox.api.ApiNetworkException bei Netzproblemen (Erkennung).
     * @throws com.chris.vox.api.ApiHttpException bei Fehlerstatus der API (Erkennung).
     */
