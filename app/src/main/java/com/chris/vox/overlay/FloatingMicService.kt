...
import com.chris.vox.a11y.TextInserterAccessibilityService
...
class FloatingMicService : Service() {
    ...
    private val io = Executors.newSingleThreadExecutor { r -> Thread(r, "vox-float-io") }
    ...
    /** Akzentfarbe der Notification folgt der Aufnahme (vox_recording waehrend RECORDING). */
    ...
    private fun fallbackClipboard(text: String) {
        runCatching {
            ...
            cm.setPrimaryClip(ClipData.newPlainText("vox", text.trim()))
        }
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.chris.vox.STOP_FLOAT"
