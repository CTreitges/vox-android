...
object MicIcon {
    ...
    fun tintRes(tint: BubbleVisual.IconTint): Int = when (tint) {
        BubbleVisual.IconTint.PRIMARY -> R.color.vox_primary
        BubbleVisual.IconTint.ON_RECORDING -> R.color.vox_onRecording
        BubbleVisual.IconTint.ON_PRIMARY_CONTAINER -> R.color.vox_onPrimaryContainer
        BubbleVisual.IconTint.ON_ERROR_CONTAINER -> R.color.vox_onErrorContainer
    }
