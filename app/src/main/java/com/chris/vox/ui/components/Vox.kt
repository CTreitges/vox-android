...
fun StatusIcon(tone: Tone, @DrawableRes neutralIcon: Int = R.drawable.ic_info, size: Dp = 24.dp) {
    ...
    when (tone) {
        Tone.SUCCESS -> VoxIcon(R.drawable.ic_check_circle, null, m, MaterialTheme.vox.success)
        Tone.WARNING -> VoxIcon(R.drawable.ic_warning, null, m, MaterialTheme.vox.warning)
        Tone.ERROR -> VoxIcon(R.drawable.ic_error, null, m, MaterialTheme.colorScheme.error)
        Tone.NEUTRAL -> VoxIcon(neutralIcon, null, m, MaterialTheme.colorScheme.onSurfaceVariant)
    }
}
        ...
        Column(Modifier.padding(contentPadding), verticalArrangement = Arrangement.spacedBy(gap)) {
            if (title != null) {
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                    if (titleIcon != null) VoxIcon(titleIcon, null, Modifier.size(24.dp), titleIconTint)
...
fun InfoCard(
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            VoxIcon(icon, null, Modifier.size(24.dp), onContainer)
...
fun ExpandableCard(
    ...
    ElevatedCard(
        ...
        Row(
            ...
            if (icon != null) VoxIcon(icon, null, Modifier.size(24.dp), MaterialTheme.colorScheme.primary)
            Text(title, style = MaterialTheme.typography.titleMedium, modifier = Modifier.weight(1f))
            VoxIcon(R.drawable.ic_expand_more, null, Modifier.size(24.dp).rotate(rotation), MaterialTheme.colorScheme.onSurfaceVariant)
        }
