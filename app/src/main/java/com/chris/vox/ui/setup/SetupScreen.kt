...
import com.chris.vox.overlay.FloatingMicService
import com.chris.vox.ui.components.PrimaryButton
import com.chris.vox.ui.components.SmallTopBar
import com.chris.vox.ui.components.StepStateChip
import com.chris.vox.ui.components.VoxIcon
import com.chris.vox.ui.components.findActivity
            ...
            SmallTopBar(
                ...
                if (inSteps) {
                    IconButton(onClick = { showOverview = true }) {
                        VoxIcon(R.drawable.ic_checklist, stringResource(R.string.setup_cd_overview))
                    }
                }
            }
        },
    ...
    Column(Modifier.fillMaxSize()) {
        Column(
            ...
            Box(
                ...
                VoxIcon(ui.icon, null, Modifier.size(36.dp), MaterialTheme.colorScheme.onPrimaryContainer)
            }
