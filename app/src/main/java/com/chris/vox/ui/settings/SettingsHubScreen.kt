...
private fun HubRow(icon: Int, headline: String, value: String, divider: Boolean = true, onClick: () -> Unit) {
    ListItem(
        ...
        leadingContent = {
            ...
            ) { VoxIcon(icon, null, Modifier.size(24.dp), MaterialTheme.colorScheme.onSurface) }
        },
        trailingContent = { VoxIcon(R.drawable.ic_chevron_right, null, Modifier.size(24.dp), MaterialTheme.colorScheme.onSurfaceVariant) },
