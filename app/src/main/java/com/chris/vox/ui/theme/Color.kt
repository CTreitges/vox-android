 ...
 * colorResource()). VoxThemeTest prueft, dass beide Listen uebereinstimmen.
 */
object VoxPalette {
    // M3-Rollen
    ...
    /** Zusatz-Tokens als VoxColors — Default von LocalVoxColors ausserhalb von VoxTheme. */
    val voxColors = VoxColors(
        recording = recording,
