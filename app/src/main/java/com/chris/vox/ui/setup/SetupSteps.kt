...
private fun EngineOption(
    ...
    OutlinedCard(
        ...
        Row(
            ...
            VoxIcon(icon, null, Modifier.size(28.dp), iconTint)
            Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                if (unavailable != null) {
                    StatusChip(unavailable, R.drawable.ic_warning, MaterialTheme.vox.warningContainer, MaterialTheme.vox.onWarningContainer)
                }
            }
        }
    }
