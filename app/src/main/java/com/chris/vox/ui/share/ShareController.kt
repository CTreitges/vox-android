...
import com.chris.vox.SharedAudioTranscriber
...
class ShareController(
    ...
    private val executor: Executor = Executors.newSingleThreadExecutor { r -> Thread(r, "vox-share-io") },
    post: ((() -> Unit) -> Unit)? = null,
) {
    ...
    companion object {
        private const val TAG = "VoxShare"
    }
}
