...
import com.chris.vox.ui.access.helpKeyText
import com.chris.vox.ui.components.DetailScaffold
import com.chris.vox.ui.components.ExpandableCard
...
import com.chris.vox.ui.components.openLink
...
import com.chris.vox.ui.setup.stepName
...
private fun HelpLine(icon: Int, text: String) {
    Row(verticalAlignment = Alignment.Top, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
        VoxIcon(icon, null, Modifier.size(24.dp), MaterialTheme.colorScheme.primary)
...
private fun ProblemEntry(title: String, body: String, onAction: () -> Unit) {
    ...
    Column {
        VoxRow(headline = title, onClick = { open = !open }, trailing = {
            VoxIcon(R.drawable.ic_expand_more, null, Modifier.size(24.dp), MaterialTheme.colorScheme.onSurfaceVariant)
        })
...
private fun HelpFooter(snack: SnackController) {
    ...
    Column(
        ...
        TextButton(onClick = { openLink(ctx, GITHUB_URL, snack) }) {
            ...
            VoxIcon(R.drawable.ic_open_in_new, stringResource(R.string.cd_open_link), Modifier.padding(start = 4.dp).size(16.dp))
        }
    }
}
