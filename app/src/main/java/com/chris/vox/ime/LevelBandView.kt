 ...
 * der Frame-Takt. Ohne Aufnahme liegen die Balken flach in vox_surfaceContainerHighest,
 * waehrend der Aufnahme leuchten sie in vox_recording.
 */
class LevelBandView @JvmOverloads constructor(
    ...
    private val activeColor = context.getColor(R.color.vox_recording)
    private val idleColor = context.getColor(R.color.vox_surfaceContainerHighest)
