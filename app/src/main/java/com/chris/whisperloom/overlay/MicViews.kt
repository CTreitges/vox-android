...
object MicIcon {
    ...
    fun tintRes(tint: BubbleVisual.IconTint): Int = when (tint) {
        BubbleVisual.IconTint.PRIMARY -> R.color.loom_primary
        BubbleVisual.IconTint.ON_RECORDING -> R.color.loom_onRecording
        BubbleVisual.IconTint.ON_PRIMARY_CONTAINER -> R.color.loom_onPrimaryContainer
        BubbleVisual.IconTint.ON_ERROR_CONTAINER -> R.color.loom_onErrorContainer
    }
