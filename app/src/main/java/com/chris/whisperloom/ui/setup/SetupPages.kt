...
private fun WelcomePoint(icon: Int, text: String) {
    LoomRow(headline = text, leading = { LoomIcon(icon, null, Modifier.size(24.dp), MaterialTheme.colorScheme.primary) })
}
        ...
        Column(
            ...
            Box(
                Modifier
                    ...
                    .background(MaterialTheme.loom.successContainer, CircleShape),
                contentAlignment = Alignment.Center,
            ) {
                LoomIcon(R.drawable.ic_check, null, Modifier.size(48.dp), MaterialTheme.loom.onSuccessContainer)
            }
